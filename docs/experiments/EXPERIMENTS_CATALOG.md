...
| `exp3_cross_dataset` | Minimal external-validation package beyond Adult | [exp3_cross_dataset/README.md](./exp3_cross_dataset/README.md) | `experiments/exp3_cross_dataset/results/`, `outputs/` |
