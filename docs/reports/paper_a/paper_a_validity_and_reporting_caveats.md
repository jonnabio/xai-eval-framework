...
**Residual risk.** This Paper A check covers only SHAP. The broader evidence base includes a separate LIME-only EXP3 extension in `outputs/analysis/exp3_lime_results.csv`, but it does not create a full paired SHAP-LIME cross-dataset stability test because SHAP stability is not paired against LIME in that extension. Anchors and DiCE remain outside the Paper A EXP3 evidence cut. Generalization of the full four-method ranking beyond Adult Income remains an open empirical question.
...
**Residual risk.** Resolved 2026-07-24: the refreshed evidence cut reported in this draft (commit `553f65d71b077ec181ad36da7bb6e7c9942fe116`, including the bundled EXP2 analysis outputs and the EXP3 cross-dataset check) is now archived in Zenodo under version-specific DOI [`10.5281/zenodo.21538180`](https://doi.org/10.5281/zenodo.21538180) (concept DOI [`10.5281/zenodo.19297723`](https://doi.org/10.5281/zenodo.19297723)), confirmed publicly resolvable via both the DOI redirect and the Zenodo public records API. The prior March 2026 snapshot remains separately archived under DOI [`10.5281/zenodo.19297724`](https://doi.org/10.5281/zenodo.19297724) for provenance. Remaining residual risks concern result availability gaps (Section 5.1) and external-validity limits (Section 5.4), not archive discoverability.
