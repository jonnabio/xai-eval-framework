...
\midrule
Independent zero masking      & +0.098 & +0.625 \\
Mean replacement               & +0.098 & +0.591 \\
Marginal empirical replacement & +0.081 & +0.534 \\
Grouped mean replacement       & +0.053 & +0.493 \\
\bottomrule
\end{tabular}
\end{table}

\noindent SHAP's fidelity advantage direction is stable across all four
schemes, but its magnitude decreases under progressively more
correlation-aware masking, consistent with the feature-correlation
discussion in Supplementary Table~S3: independent masking of correlated
features inflates the apparent SHAP--LIME gap relative to masking schemes
that account for feature dependence.
