# Corpus PDF retrieval log

Written by `scripts/pubs/fetch_corpus_pdfs.py`. STATUS is DONE, FAILED or PENDING.

| citation_key | status | source_url | note |
|---|---|---|---|
| `adebayo2018sanity` | DONE | https://arxiv.org/pdf/1810.03292 | OpenAlex title search; verified (title overlap 1.00, 10788 KB) |
| `alvarezmelis2018robustness` | DONE | https://arxiv.org/pdf/1806.08049 | arXiv 1806.08049 (from bibliography); verified (title overlap 1.00, 1747 KB) |
...
| `zheng2023judging` | DONE | https://arxiv.org/pdf/2306.05685 | arXiv 2306.05685 (from bibliography); verified (title overlap 1.00, 1543 KB) |
| `ali2023trustworthy` | DONE | https://digibug.ugr.es/bitstream/10481/84480/1/1-s2.0-S1566253523001148-main.pdf | OpenAlex title search; verified (title overlap 1.00, 7916 KB) |
| `bansal2021whole` | DONE | https://arxiv.org/pdf/2006.14779 | OpenAlex title search; verified (title overlap 1.00, 3340 KB) |
| `burkart2021survey` | DONE | https://jair.org/index.php/jair/article/download/12228/26647 | OpenAlex open-access location; verified (title overlap 1.00, 845 KB) |
| `canha2025benchmark` | DONE | https://dl.acm.org/doi/pdf/10.1145/3737445 | OpenAlex open-access location; verified (title overlap 1.00, 1202 KB) |
| `fok2023verifiability` | DONE | https://arxiv.org/pdf/2305.07722 | OpenAlex title search; verified (title overlap 1.00, 901 KB) |
| `haufe2026formalization` | DONE | https://www.nature.com/articles/s44387-026-00095-1.pdf | OpenAlex open-access location; verified (title overlap 1.00, 692 KB) |
| `hooker2019benchmark` | DONE | https://arxiv.org/pdf/1806.10758 | OpenAlex title search; verified (title overlap 1.00, 2978 KB) |
...
| `wilming2023theoretical` | DONE | https://arxiv.org/pdf/2306.01464 | OpenAlex title search; verified (title overlap 1.00, 3820 KB) |
