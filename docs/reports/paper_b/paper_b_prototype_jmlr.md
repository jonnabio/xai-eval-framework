# LIME vs SHAP: A Comprehensive Empirical Comparison
...
(\(n=65\) matched SHAP-LIME cells). Active ratio is reported directly;
...
in 50 of 65 matched cells, with a median cost ratio of approximately
...
\caption{Runtime behavior under matched-cell pairing (\(n=65\)). Left:
