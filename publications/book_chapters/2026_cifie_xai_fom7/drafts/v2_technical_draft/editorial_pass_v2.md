...
- Extensión aproximada tras enriquecer la crisis de evaluación XAI: 14,679 palabras, incluyendo referencias.
...
- Continuar la conversión de citas restantes a formato APA 7 en texto; `02_introduccion.md`, `03_fundamentos_xai.md`, `04_metodos_lime_shap_anchors_dice.md` y `05_crisis_evaluacion_xai.md` ya fueron convertidos a estilo autor-año.
