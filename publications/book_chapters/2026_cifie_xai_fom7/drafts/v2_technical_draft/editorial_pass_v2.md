...
- Extensión aproximada tras enriquecer el protocolo FOM-7: 16,251 palabras, incluyendo referencias.
...
- Continuar la conversión de citas restantes a formato APA 7 en texto; `02_introduccion.md`, `03_fundamentos_xai.md`, `04_metodos_lime_shap_anchors_dice.md`, `05_crisis_evaluacion_xai.md` y `06_protocolo_fom7.md` ya fueron convertidos a estilo autor-año.
