...
& "C:\Program Files\Quarto\bin\quarto.exe" render index.qmd --to docx

if ($LASTEXITCODE -eq 0) {
    Write-Host "`nSUCCESS: Thesis rendered to $outDir/JHerrera_XAI_Tesis_Doctorado.docx" -ForegroundColor Green
