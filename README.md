...
| **[EXP3: Cross-Dataset Validation](docs/experiments/exp3_cross_dataset/README.md)** | Minimal external-validation package to test whether key Adult-benchmark findings generalize to additional tabular datasets. | Ready for partitioned execution |
...
- [**EXP3 Partitioned Execution Plan**](docs/planning/exp3_partitioned_execution_plan.md): Windows + Linux/WSL split-run procedure for the EXP3 matrix.
